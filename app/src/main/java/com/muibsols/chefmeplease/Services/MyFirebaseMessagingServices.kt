...
import com.muibsols.chefmeplease.UI.Activities.BaseActivity
import java.util.*
    ...
    override fun onMessageReceived(p0: RemoteMessage) {
      ...
      */
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            notificationBuilder.color = resources.getColor(R.color.black_shade)
        }
