...
class PorkFragment : Fragment(),DishClickListener,FavClickListener, OptionClickListener {
    ...
    val dbRef = database.getReference("Categories").child("Pork").child("Dishes")
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_pork, container, false)
        initViews(view)
        return view
    }
