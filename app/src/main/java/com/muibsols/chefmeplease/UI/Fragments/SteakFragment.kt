...
class SteakFragment : Fragment(),DishClickListener,FavClickListener,OptionClickListener{
    ...
    val dbRef = database.getReference("Categories").child("Steak").child("Dishes")
