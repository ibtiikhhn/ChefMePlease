...
class SeafoodFragment : Fragment(),DishClickListener,FavClickListener, OptionClickListener {
    ...
    val dbRef = database.getReference("Categories").child("Seafood").child("Dishes")
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_seafood, container, false)
        initViews(view)
        return view
    }
